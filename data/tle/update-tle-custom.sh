...
sed -i "s/LEMUR-2-ROHOVITHSA/FOREST-1/g" custom/ot.txt
cat ext/ot-add.txt >> custom/ot.txt 2> /dev/null
egrep -A2 '^(SENTINEL-2A|SENTINEL-2B|SENTINEL-3A|SENTINEL-3B|AQUA|TERRA |SUOMI NPP|NOAA 20|NOAA 21|METEOSAT-8|METEOSAT-10|METEOSAT-11|GOES 16|GOES 17|GOES 18|HIMAWARI-8|HIMAWARI-9|METOP-A|METOP-B|METOP-C|LANDSAT 8|LANDSAT 9|FENGYUN 3D|GEO-KOMPSAT-2A|GCOM-C)' --no-group-separator groups/active.txt > custom/wfs.txt
