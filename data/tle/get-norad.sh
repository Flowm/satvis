...
egrep -A2 '^(SENTINEL-3A|SENTINEL-3B|AQUA|TERRA |SUOMI NPP|NOAA 20|METEOSAT-8|METEOSAT-10|METEOSAT-11|GOES 16|GOES 17|HIMAWARI-8)' --no-group-separator active.txt > ../ext/wfs.txt
egrep -A2 '^(SENTINEL-3A|SENTINEL-3B|AQUA|TERRA |SUOMI NPP|NOAA 20|METEOSAT-8|METEOSAT-10|METEOSAT-11|GOES 16|GOES 17|HIMAWARI-8|NOAA 15|NOAA 18|NOAA 19|METOP-A|METOP-B|METOP-C)' --no-group-separator active.txt > ../ext/wfsf.txt
